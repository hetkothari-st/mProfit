 ...
 * price (as an earlier draft of this function did) loses the actual-cost
 * floor whenever cost > sale price, understating losses on capital-loss rows.
 * When FMV is unknown, Col 11/Col 12 are left blank and Col 13 falls back to
 * the uncorrected actual cost per unit (no grandfathering applied).
 */
