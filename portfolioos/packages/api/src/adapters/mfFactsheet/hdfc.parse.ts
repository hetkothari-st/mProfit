...
export const HDFC_TABLE_SPEC: AmcTableSpec = {
  ...
  // VERIFIED 2026-09-07: "Market/ Fair Value (Rs. in Lacs.)" — "Lacs", and a
  // trailing period inside the bracket.
  marketValueUnit: 'LAKH',
  columns: {
    // VERIFIED: "Name Of the Instrument". HDFC puts ISIN BEFORE the name; the
    // walker maps by header position, so column ORDER never matters.
  ...
  asOfPatterns: [
    // VERIFIED: "Portfolio as on 31-Jul-2026".
