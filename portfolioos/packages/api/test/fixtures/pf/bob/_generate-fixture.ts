...
doc.font('Courier').fontSize(12).text('Bank of Baroda Public Provident Fund (PPF) Statement', { align: 'center' });
doc.fontSize(10).text('Account No: 12345678901234');
doc.text('Customer Name: TEST USER');
doc.text('Branch: ANDHERI EAST BRANCH (BOB-12345)');
doc.text('Period: 01-04-2023 to 31-03-2024');
doc.moveDown();
doc.text('Date         Particulars                    Withdrawal   Deposit      Balance');
doc.text('01-04-2023   Opening Balance                             130000.00    130000.00');
doc.text('12-08-2023   PPF Deposit                                 12000.00     142000.00');
doc.text('18-02-2024   Self Deposit                                13000.00     155000.00');
doc.text('31-03-2024   Interest Credited                           10710.00     165710.00');
doc.end();
